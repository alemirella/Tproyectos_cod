...
const navItems = [
  ...
  { to: "/schedules/results", label: "Horarios", icon: Clock },
...
export default function Sidebar({ mobileOpen = false, onNavigate }) {
  ...
  return (
    <aside
      className={`fixed inset-y-0 left-0 z-40 flex w-[min(260px,88vw)] flex-col bg-gradient-to-b from-sgoha-sidebar-from to-sgoha-sidebar-to text-white shadow-xl transition-transform duration-300 ease-out lg:translate-x-0 ${
