 ...
 * Esta es la única fuente de verdad para horarios del sistema. No editar
 * sin coordinar con la versión espejo de `frontend/src/constants/timeBlocks.js`.
 *
 * Total: 14 bloques x 7 días = 98 franjas posibles por semana.
 */
...
/**
 * Combinaciones completas día x bloque (98). Útil para el seed y para
 * validar que una franja recibida está dentro del catálogo oficial.
 */
